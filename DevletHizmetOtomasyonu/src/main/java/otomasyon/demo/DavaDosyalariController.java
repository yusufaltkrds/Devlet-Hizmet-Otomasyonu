...
public class DavaDosyalariController implements Initializable {
    ...
    @FXML
    private TableView<DavaDosyalarim> tableView;

    @FXML
    private TableColumn<Araclarim,String> adli_birim;

    @FXML
    private TableColumn<Araclarim,String> acilis_tarihi;

    @FXML
    private TableColumn<Araclarim,String> taraf_rolu;

    @FXML
    private TableColumn<Araclarim, String> dosya_turu;



    ObservableList<DavaDosyalarim> list = FXCollections.observableArrayList(HelloApplication.vatandaslar.get(GirisEkraniController.i).getDavalarim());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        adli_birim.setCellValueFactory(new PropertyValueFactory<Araclarim,String>("adli_birim"));
        acilis_tarihi.setCellValueFactory(new PropertyValueFactory<Araclarim,String>("acilis_tarihi"));
        taraf_rolu.setCellValueFactory(new PropertyValueFactory<Araclarim,String>("taraf_rolu"));
        dosya_turu.setCellValueFactory(new PropertyValueFactory<Araclarim,String>("dosya_turu"));
