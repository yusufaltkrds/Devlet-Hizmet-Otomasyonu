...
public class SGKController implements Initializable {
    ...
    @FXML
    private TableView<SGK> tableView;

    @FXML
    private TableColumn<SGK, String> sigorta_kolu;

    @FXML
    private TableColumn<SGK, String> sigorta_statusu;

    @FXML
    private TableColumn<SGK, String> ad;

    @FXML
    private TableColumn<SGK, String> soyad;

    @FXML
    private TableColumn<SGK, String> donem;

    ObservableList<SGK> list = FXCollections.observableArrayList(HelloApplication.vatandaslar.get(GirisEkraniController.i).getSGKlar());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        sigorta_kolu.setCellValueFactory(new PropertyValueFactory<SGK, String>("sigorta_kolu"));
        sigorta_statusu.setCellValueFactory(new PropertyValueFactory<SGK, String>("sigorta_statusu"));
        ad.setCellValueFactory(new PropertyValueFactory<SGK, String>("ad"));
        soyad.setCellValueFactory(new PropertyValueFactory<SGK, String>("soyad"));
        donem.setCellValueFactory(new PropertyValueFactory<SGK, String>("donem"));
